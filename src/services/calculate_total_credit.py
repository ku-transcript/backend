...
s = sum([total_credit[c] for c in ["วิชาแกน", "วิชาเฉพาะบังคับ", "วิชาเฉพาะเลือก", "ภาษากับการสื่อสาร", "พลเมืองไทยและพลเมืองโลก", "ศาสตร์แห่งผู้ประกอบการ", "สุนทรียศาสตร์", "อยู่ดีมีสุข"]])
print(s)